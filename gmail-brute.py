...
# Gmail Hack
# DISCRIPTION ////
# Bro don't use this code for any illigal purpose...
...
def create_main_window(settings):
    sg.theme(settings['theme'])
    menu_def = [['&Menu', ['&Copy', '&Paste','Settings', 'E&xit','Discription']],
                ['&Help', '&About...','Discription']]
    ...
    layout = [[sg.Menu(menu_def)],
              [sg.Text('', size=(32,1), font=('Helvetica', 9)),
                 ...
                 sg.Button('', key='join us', size=(12,1), font=('Helvetica', 9), button_color=(sg.theme_background_color(), sg.theme_background_color()),
                           image_filename='png/yellow.png', image_size=(80, 60), image_subsample=2, border_width=0)],   
    ...
    return sg.Window('Gmail Hack --by Jerry',
                     layout=layout,
...
def main():
    ...
    while True:
        ...
        if event in (None, 'Exit'):
            ...
            webbrowser.open_new_tab("https://www.instagram.com/xhacking_official/")
        
        elif event == 'Join us':
            webbrowser.open_new_tab("https://www.github.com/Jerry4539/")

        elif event == 'About...':
            window.disappear()
            sg.popup('About:', 'Created by Jerry4539.', 'Gmail Hack', 'Version 1.2')
            window.reappear()
